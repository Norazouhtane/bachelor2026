...
def load_data(
    ...
    """
    Load and prepare ESS 2023 data for modelling.

    Parameters:
        data_path (string): Path to ESS11 CSV file.
        codebook_path (string): Path to ESS11 codebook HTML file.
...
test_cols = [
    ...
    'testji8', 'testji9', 'testjc34', 'testjc35', 'testjc36', 'testjc37', 'testjc38', 
    'testjc39', 'testjc40', 'testjc41', 'testjc42'
]
